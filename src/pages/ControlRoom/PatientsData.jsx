...
export default function PatientsData() {
  ...
  return (
    <Grid templateColumns={{ base: "", md: "auto 1fr" }} gap={{ sm: 3, md: 5, lg: 6 }} p={{ sm: 3, md: 5, lg: 6 }} h={{ lg: "100vh" }}>
      ...
      <GridItem colSpan={1} bg="white" py={5} px={6} rounded="md" shadow="md">
        <Flex direction="column" h="full">
          ...
          {/* BUTTON NEW PATIENT */}
          <Button onClick={onOpen} colorScheme="teal" mt={8}>Add New Patient</Button>

          {/* MODAL NEW PATIENT */}
          <ModalNewPatient isOpen={isOpen} onClose={onClose}/>
